...
public class EuropeanOptionSmileByCarrMadan extends EuropeanOptionSmile {
	...
	public EuropeanOptionSmileByCarrMadan(double maturity, double[] strikes, int numberOfPoints,
	...
	public EuropeanOptionSmile getCloneWithModifiedParameters(double maturity, double[] strikes) {
		...
		return new EuropeanOptionSmileByCarrMadan(maturity, strikes, this.numberOfPoints,
