...
public class OptimizerFactoryLevenbergMarquardt implements OptimizerFactoryInterface {
	...
	@Override
	public OptimizerInterface getOptimizer(final ObjectiveFunction objectiveFunction, double[] initialParameters, double[] lowerBound, double[]  upperBound, double[] parameterSteps, double[] targetValues, double[] weights) {
		return (new LevenbergMarquardt(
				regularizationMethod,
				initialParameters,
				targetValues,
