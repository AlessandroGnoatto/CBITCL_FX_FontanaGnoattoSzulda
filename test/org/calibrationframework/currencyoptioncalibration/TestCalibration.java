...
import org.calibrationframework.fouriermethod.calibration.CurrencyOptionCalibrationProblem;
...
public class TestCalibration {
	...
	public void test() throws SolverException {
		...
		double[] initialParams =  new double[] {
				...
				1.8584473673316646,
				0.9087318674403428,
				0.012493965313398872,
				8.720724750328184E-4,
				0.5136031458720751,
				0.06517979851996566,
				0.02995472516120675,
				0.5651678158900869,
		 ...
		 * Parameter steps
		 */
		double[] parameterSteps =  new double[] {
				0.01,
				0.01,
				0.01,
				0.01,
		...
		CurrencyOptionCalibrationProblem problem = new CurrencyOptionCalibrationProblem(surfaces, model, optimizerFactory, pricer,
				initialParams, parameterSteps);
	
		System.out.println("Calibration started");
		
		long startMillis	= System.currentTimeMillis();
		CurrencyOptionCalibrationProblem.OptimizationResult result = problem.runCalibration();
