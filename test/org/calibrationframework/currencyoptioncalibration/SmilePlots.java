...
import org.calibrationframework.fouriermethod.plots.*;
...
public class SmilePlots {
	...
	public static void main(String[] args) {
		...
		int d = 1; //Dimension of the underlying process.
		...
		double[] lambdasJPY = {0.6};
		double[] lambdasUSD = {0.9};
		double[] lambdasEUR = {0.3};
		 ...
		 * Best-fit parameters
		 */
		double[] bestFitParams1 =  new double[] {
				2.75081487022273,
				0.563876742836465,
				1.67969695427533,
				1.28389361872461,
		...
		double[] bestFitParams2 =  new double[] {
				0.647346364152931,
				0.052048111257237,
				-2.03882474050045,
				0.514749439323031,
		...
		TemperedStableCBITCLMultiCurrencyModel calibratedModel = model.getCloneForModifiedParameters(bestFitParams2);
		
		//Plotting the EURUSD smiles
		SmilePlottingClass smilePlotting = new SmilePlottingClass(surfaces, calibratedModel, pricer);
		smilePlotting. plotSmile("USDJPY", maturities[5], 8);
