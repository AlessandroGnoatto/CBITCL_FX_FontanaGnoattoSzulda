...
import org.calibrationframework.fouriermethod.calibration.deeplearning.DataGenerator;
...
public class TestDataGenerator {
	...
	public void test() {
		...
		DataGenerator dataGen = new DataGenerator(model, pricer, weightedSurfaces);
		
		int dataSampleSize = 1000;
		
		System.out.println("Retrieving of data starting point");
		
		long startMillis = System.currentTimeMillis();
		try {
			dataGen.generateDataAllSurfaces(dataSampleSize);
		} catch (IOException e) {
			e.printStackTrace();
		}
		...
		System.out.println("Retrieving of data completed in: " + calculationTime + " seconds");
